...
const TEXTS = {
  ru: {
    ...
    catalog: {
      ...
      syncDone: "Обновлено",
      syncSourceError: "Не удалось обновить все отчёты: источник вернул ошибки. Попробуйте позже.",
  ...
  en: {
    ...
    catalog: {
      ...
      syncing: "Syncing...",
      syncDone: "Updated",
      syncSourceError: "Some reports could not be refreshed because the source returned errors. Please try again later.",
  ...
  uz: {
    ...
    catalog: {
      ...
      syncDone: "Yangilandi",
      syncSourceError: "Manbadagi xatolar sababli barcha hisobotlarni yangilab bo'lmadi. Keyinroq qayta urinib ko'ring.",
