...
const TEXTS = {
  ru: {
    ...
    sections: {
      ...
      РЫНОЧНЫЕ_ДАННЫЕ: "Рыночные данные",
      ...
      ВЕРДИКТ: "Вердикт",
      СОВЕТЫ: "Советы",
      ОГРАНИЧЕНИЯ_ПУБЛИЧНОГО_КОНТУРА: "Ограничения публичного контура",
      ИТОГ: "Итог",
  ...
  en: {
    ...
    sections: {
      ...
      ОГРАНИЧЕНИЯ_ПУБЛИЧНОГО_КОНТУРА: "Public scope limits",
      ИТОГ: "Summary",
  ...
  uz: {
    ...
    sections: {
      ...
      РЫНОЧНЫЕ_ДАННЫЕ: "Bozor ma'lumotlari",
      ...
      ВЕРДИКТ: "Xulosa",
      СОВЕТЫ: "Tavsiyalar",
      ОГРАНИЧЕНИЯ_ПУБЛИЧНОГО_КОНТУРА: "Ommaviy kontur cheklovlari",
      ИТОГ: "Yakun",
