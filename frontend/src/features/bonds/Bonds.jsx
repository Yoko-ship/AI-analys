...
import BondPaymentCalendar from "./BondPaymentCalendar.jsx";
    ...
    <section className="panel pad bond-market-position" data-testid="bond-market-position">
      ...
      <p className="muted bondsec-note">
        ...
        {me.day_count_source === "filed_coupons"
          ? t("Расчёт опирается на опубликованные суммы купонов.", "Hisob-kitob e’lon qilingan kupon summalariga asoslangan.", "The calculation uses disclosed coupon amounts.")
