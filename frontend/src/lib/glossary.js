...
export const TERMS = {
  ...
  finCash: {
    ru: { term: "Наличность в кассе", def: "Остаток на расчётном счёте (счёт 5100 баланса) на отчётную дату. Это только операционный счёт: касса, валютные счета и краткосрочные вложения сюда не входят, поэтому величина бывает заметно меньше всех денежных средств компании. Ноль означает пустой счёт на дату, а не отсутствие данных. У банков строки 5100 нет — там показана кассовая наличность и другие платёжные документы. Это положение на дату, а не результат за период, — сравнивать с выручкой напрямую нельзя." },
    en: { term: "Cash", def: "The balance on the settlement account (balance-sheet line 5100) at the reporting date. Only the operating account: petty cash, FX accounts and short-term deposits are excluded, so the figure is often well below the company's total cash. A zero means an empty account on the date, not missing data. Banks have no line 5100 — for them this is cash and other payment documents. A position on a date, not a result over a period, so it does not compare directly with revenue." },
    uz: { term: "Kassadagi naqd pul", def: "Hisobot sanasida hisob-kitob schyotidagi qoldiq (balansning 5100-qatori). Bu faqat operatsion schyot: kassa, valyuta schyotlari va qisqa muddatli qo‘yilmalar bunga kirmaydi, shu sababli raqam kompaniyaning barcha pul mablag‘laridan sezilarli kam bo‘lishi mumkin. Nol — sanadagi bo‘sh schyot, ma’lumot yo‘qligi emas. Banklarda 5100-qator yo‘q — ularda kassa naqdi va boshqa to‘lov hujjatlari ko‘rsatiladi. Bu davr natijasi emas, sanadagi holat." },
  },
  finLiab: {
    ru: { term: "Общие обязательства", def: "Итог раздела обязательств баланса — то, что эмитент напечатал сам: «Итого по разделу III (стр.730+930)» в страховой форме, «Итого по II разделу (стр.490+600)» в форме АО. Это всё, что компания должна на отчётную дату: кредиты, займы, кредиторская задолженность, налоги к уплате. Тоже положение на дату, а не поток за период." },
    en: { term: "Total liabilities", def: "The obligations subtotal as the issuer itself published it — «Итого по разделу III (стр.730+930)» on the insurance form, «Итого по II разделу (стр.490+600)» on the joint-stock one. Everything the company owes at the reporting date: loans, borrowings, payables, taxes due. Also a position on a date rather than a flow over a period." },
    uz: { term: "Umumiy majburiyatlar", def: "Balansning majburiyatlar bo‘limi yakuni — emitentning o‘zi chop etgan qatori: sug‘urta shaklida «Итого по разделу III (стр.730+930)», AJ shaklida «Итого по II разделу (стр.490+600)». Bu kompaniyaning hisobot sanasidagi barcha qarzlari: kreditlar, qarzlar, kreditorlik qarzi, to‘lanishi kerak bo‘lgan soliqlar. Bu ham davr oqimi emas, sanadagi holat." },
  },
  ebitda: {
  ...
  pe: {
    ...
    en: { term: "P/E (price to earnings)", def: "Market capitalisation over the last twelve months of net income: how many years of profit the current price is worth. When a quarterly or half-year filing follows the annual one, the base is a sliding year: the annual profit + the current year's reported months − the same months a year earlier. A caption like «2025A + 6М2026 − 6М2025» is that formula spelled out — the base is always exactly twelve months, never eighteen. Where the filings hold no comparable prior period, the last complete year is used; the cell names its period." },
    uz: { term: "P/E (narx / foyda)", def: "Kapitalizatsiyaning so‘nggi 12 oylik sof foydaga nisbati: joriy narx necha yillik foydaga teng. Yillik hisobotdan keyin choraklik yoki yarim yillik hisobot chiqqan bo‘lsa, baza — sirg‘aluvchi yil: yillik foyda + joriy yilning hisobot oylari − o‘tgan yilning xuddi shu oylari. «2025A + 6М2026 − 6М2025» ko‘rinishidagi yozuv ana shu formulaning o‘zi — bazada doim roppa-rosa 12 oy, 18 emas. Solishtiriladigan o‘tgan yilgi davr bo‘lmasa, oxirgi to‘liq yil olinadi; davr katakning o‘zida yozilgan." },
  },
  pb: {
