...
Расшифровка: Профессиональная интерпретация балла в контексте рынка Узбекистана. Какие факторы определили оценку, как она соотносится с отраслевыми ориентирами.

[ДОСЬЕ]
Краткая справка об эмитенте в формате аналитической записки:
Полное наименование, дата регистрации, основной вид деятельности. Позиционирование на рынке (лидер/средний игрок/нишевой). Ключевые направления бизнеса и источники выручки. Структура собственности (если известна).

[ЧТО_С_ДЕНЬГАМИ]
Общая оценка финансового состояния эмитента.

Изложи ключевые выводы о финансовом здоровье компании: способность генерировать прибыль, динамика основных показателей, уровень долговой нагрузки, достаточность ликвидности. Каждый тезис должен опираться на конкретные цифры из отчётности.

Сопоставь показатели с отраслевыми ориентирами Узбекистана, а не с глобальными стандартами. Укажи, какие метрики вызывают опасения, а какие демонстрируют силу эмитента.

[ГОРИЗОНТАЛЬНЫЙ_АНАЛИЗ]
Горизонтальный анализ позволяет количественно оценить направление и масштаб изменений в структуре активов, обязательств и капитала за анализируемый период.

2.1. Анализ динамики активов

| Статья актива | Текущий период | Предыдущий период | Изм., абс. | Изм., % |
|---------------|----------------|-------------------|------------|---------|
| Денежные средства | X XXX XXX | X XXX XXX | +/-X XXX | +/-X,X% |
| Дебиторская задолженность | X XXX XXX | X XXX XXX | +/-X XXX | +/-X,X% |
| Запасы | X XXX XXX | X XXX XXX | +/-X XXX | +/-X,X% |
| Основные средства | X XXX XXX | X XXX XXX | +/-X XXX | +/-X,X% |
| ИТОГО АКТИВОВ | X XXX XXX | X XXX XXX | +/-X XXX | +/-X,X% |

Интерпретация динамики активов: развёрнутый анализ причин изменений по ключевым статьям.

2.2. Анализ динамики обязательств и капитала

| Статья пассива | Текущий период | Предыдущий период | Изм., абс. | Изм., % |
|----------------|----------------|-------------------|------------|---------|
| Краткосрочные обязательства | X XXX XXX | X XXX XXX | +/-X XXX | +/-X,X% |
| Долгосрочные обязательства | X XXX XXX | X XXX XXX | +/-X XXX | +/-X,X% |
| Собственный капитал | X XXX XXX | X XXX XXX | +/-X XXX | +/-X,X% |
| ИТОГО ПАССИВОВ | X XXX XXX | X XXX XXX | +/-X XXX | +/-X,X% |

Интерпретация динамики пассивов: анализ изменений в структуре финансирования.

2.3. Анализ динамики финансовых результатов

| Показатель | Текущий период | Предыдущий период | Изм., абс. | Изм., % |
|------------|----------------|-------------------|------------|---------|
| Выручка | X XXX XXX | X XXX XXX | +/-X XXX | +/-X,X% |
| Валовая прибыль | X XXX XXX | X XXX XXX | +/-X XXX | +/-X,X% |
| Операционная прибыль (EBIT) | X XXX XXX | X XXX XXX | +/-X XXX | +/-X,X% |
| Чистая прибыль | X XXX XXX | X XXX XXX | +/-X XXX | +/-X,X% |

Интерпретация: качество роста выручки и эффективность конверсии в прибыль.

[ВЕРТИКАЛЬНЫЙ_АНАЛИЗ]
Вертикальный анализ позволяет оценить структуру баланса вне зависимости от абсолютных значений, приводя все статьи к процентному соотношению с итоговой суммой.

3.1. Структура активов (% от итога баланса)

| Статья актива | Текущий период | % к итогу | Предыдущий период | % к итогу |
|---------------|----------------|-----------|-------------------|-----------|
| Денежные средства | X XXX | X,X% | X XXX | X,X% |
| Дебиторская задолженность | X XXX | X,X% | X XXX | X,X% |
| Запасы | X XXX | X,X% | X XXX | X,X% |
| Основные средства | X XXX | X,X% | X XXX | X,X% |
| Прочие активы | X XXX | X,X% | X XXX | X,X% |

Интерпретация структуры активов: какие активы преобладают и что это означает для бизнеса.

3.2. Структура пассивов (% от итога баланса)

| Статья пассива | Текущий период | % к итогу | Предыдущий период | % к итогу |
|----------------|----------------|-----------|-------------------|-----------|
| Собственный капитал | X XXX | X,X% | X XXX | X,X% |
| Долгосрочные обязательства | X XXX | X,X% | X XXX | X,X% |
| Краткосрочные обязательства | X XXX | X,X% | X XXX | X,X% |

Интерпретация: уровень финансовой автономии — доля собственного капитала X,X% означает [высокую/умеренную/низкую] зависимость от заёмных средств.

3.3. Структура доходов и расходов

| Показатель | Значение | % от выручки |
|------------|----------|--------------|
| Выручка | X XXX XXX | 100,0% |
| Себестоимость | X XXX XXX | X,X% |
| Валовая прибыль | X XXX XXX | X,X% |
| Операционные расходы | X XXX XXX | X,X% |
| Операционная прибыль | X XXX XXX | X,X% |
| Чистая прибыль | X XXX XXX | X,X% |

Вывод о структуре: [сбалансированная / требует внимания / рискованная] — обоснование.

[КОЭФФИЦИЕНТНЫЙ_АНАЛИЗ]
Расчёт и интерпретация ключевых финансовых коэффициентов по пяти группам.

4.1. Показатели ликвидности

• Текущая ликвидность (Current Ratio)
  Формула: Оборотные активы / Краткосрочные обязательства = X,XX
  Интерпретация: [норма для UZ: 1,5-2,5] — компания [способна/испытывает трудности] покрывать краткосрочные обязательства

• Быстрая ликвидность (Quick Ratio)
  Формула: (Оборотные активы − Запасы) / Краткосрочные обязательства = X,XX
  Интерпретация: [норма для UZ: 0,8-1,5]

• Абсолютная ликвидность (Cash Ratio)
  Формула: Денежные средства / Краткосрочные обязательства = X,XX
  Интерпретация: мгновенная платёжеспособность

4.2. Показатели рентабельности

• ROE (Return on Equity) — рентабельность собственного капитала
  Формула: Чистая прибыль / Собственный капитал × 100% = X,X%
  Интерпретация: на каждые 100 сум капитала акционеров компания генерирует X сум прибыли [норма для UZ: >12%]

• ROA (Return on Assets) — рентабельность активов
  Формула: Чистая прибыль / Активы × 100% = X,X%
  Интерпретация: эффективность использования всех активов [норма для UZ: >5%]

• ROS (Return on Sales) — рентабельность продаж
  Формула: Чистая прибыль / Выручка × 100% = X,X%
  Интерпретация: маржинальность бизнеса

4.3. Показатели долговой нагрузки

• Debt Ratio — коэффициент задолженности
  Формула: Обязательства / Активы × 100% = X,X%
  Интерпретация: доля заёмного финансирования [безопасный уровень: <60%]

• Debt/Equity — соотношение долга к капиталу
  Формула: Обязательства / Собственный капитал = X,XX
  Интерпретация: [норма: <1,5]

• Interest Coverage — покрытие процентов
  Формула: EBIT / Процентные расходы = X,XX раз
  Интерпретация: способность обслуживать долг [минимум: >2,0]

4.4. Показатели эффективности

• Оборачиваемость активов = Выручка / Средние активы = X,XX
...
ИТОГОВАЯ ОЦЕНКА ПО КОЭФФИЦИЕНТАМ: X из 5 групп показателей в норме.
