...
ANALYSIS_POLICY_VERSION = "public-information-v4-bank-aware-2026-05-27"
...
[ОЦЕНКА_ЦЕНЫ]
Оцени, выглядит ли компания дешёвой или дорогой по DCF (упрощённый расчёт справедливой
стоимости через дисконтированные денежные потоки) и через сравнение с отраслью.
Не упоминай Piotroski, Altman, Buffett, Graham — эти модели в отчёте не показываются.
...
def run_analysis(company_name: str, company_profile: str, annual_data: list,
    ...
    instructions = (
        ...
        "СРАЗУ после метки секции — одна короткая строка 'TL;DR: <главный вывод секции, 12-25 слов, с конкретными цифрами>'. "
        "Только потом идёт основной текст секции. "
        ...
        "ЯЗЫК ПРОСТЫМИ СЛОВАМИ: если используешь термин или аббревиатуру "
        "(ROE, ROA, EBIT, EBITDA, NIM, ЧПД, CIR, LTD, LDR, CAR, P/E, D/E, NPL, free cash flow), "
        "СРАЗУ в скобках давай пояснение на 3-7 слов. "
