...
const CALENDAR_ANNOUNCEMENT = {
  announcement_id: "21349",
  language: "ru",
  title: "Проведение внеочередного общего собрания акционеров",
  organization: '"Sinov kompaniyasi" AJ',
  metadata: [
  ...
  organization_details: [{ label: "ИНН", value: "200000001" }],
  pdf_url: "https://openinfo.uz/ru/announce/to_pdf/21349/",
  source_url: "https://openinfo.uz/ru/announce/21349",
};
...
test("clicking a calendar meeting opens the announcement on our site", async ({ page }) => {
  ...
  await expect(page.getByText("Первый вопрос повестки дня.")).toBeVisible();
