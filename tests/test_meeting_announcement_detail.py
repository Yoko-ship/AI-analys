...
<html><body><main>
  <div>
    <div>
      <h1>Навбадтан ташкари умумий йигилиш</h1>
    ...
    <a href="https://openinfo.uz/ru/announce/to_pdf/21211/">Скачать PDF</a>
    <div class="prose"><div>
...
def test_announcement_detail_parses_safe_structured_content() -> None:
    ...
    assert item["title"] == "Навбадтан ташкари умумий йигилиш"
    ...
    assert item["pdf_url"].endswith("/announce/to_pdf/21211/")
